...
export class TodoCardComponent implements OnInit {
  ...
  /*
  O interessante do computed é que ele observa automaticamente as dependências que foram usadas dentro dele. 
  Isso significa que sempre que todosSignal for atualizado, todosList será recalculado automaticamente, garantindo que esteja sempre em sincronia com o estado atual. 
  Isso é muito útil em situações onde você quer que certos valores sejam derivados de outros, mantendo tudo atualizado de forma automática.
  */
